      ...
      <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <input type="text" name="" value="" placeholder="IDTOT" class="form-control"> <br>
            <label for="">Usuario crea Orden de Trabajo</label> <br>
            <input type="text" name="" value="" placeholder="IDTUSRCRE" class="form-control"> <br>
            <label for="">Centro de operacion</label> <br>
            <input type="text" name="" value="" placeholder="IDTCNTOPR" class="form-control"> <br>
